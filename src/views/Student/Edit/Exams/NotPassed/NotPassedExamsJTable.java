...
public class NotPassedExamsJTable extends JTable {
	
	private static final long serialVersionUID = -596692514521391681L;
	private static NotPassedExamsJTable table;

	private NotPassedExamsJTable() {
	...
	public static NotPassedExamsJTable getInstance() {
		if (table == null)
			table = new NotPassedExamsJTable();
		return table;
	}
